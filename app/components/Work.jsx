    ...
    return (
      ...
      id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
         ...
         {workData.map((project, index) => (              
             ...
             href={project.url} target="_blank" rel="noopener noreferrer" key={index} className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg 
             relative cursor-pointer group' 
             style={{backgroundImage: `url(${project.bgImage})`}}> 
                 <div className='bg-white w-10/12 rounded-md absolute bottom-5 
                 left-1/2 -translate-x-1/2 py-3 px-5 items-center justify-between 
                 duration-500 group-hover:bottom-7'>
                     ...
                     group-hover:bg-lime-300 translate'>
...
<motion.a
    ...
    href="https://github.com/MdNoorAhmed" // Replace with your preferred URL
