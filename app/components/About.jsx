    ...
    >
      ...
      gap-20 my-20'>
        ...
        className='w-64 sm:w-80 rounded-3xl max-w-none'>
            <Image src={assets.noorpic2} alt='user' 
        ...
        className='flex-1'>
            <p className='mb-10 max-w-2xl font-Ovo'>
                Developer on a mission: Build web experiences that outlive trends. 
                Armed with React and an MSc’s theoretical depth, 
                I architect interfaces that balance tomorrow’s tech 
                with timeless usability – because good software shouldn’t expire.</p>
